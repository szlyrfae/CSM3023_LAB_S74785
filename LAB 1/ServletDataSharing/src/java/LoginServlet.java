...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(user.equals("Lyraa") && pass.equals("1013")){
            request.setAttribute("accountType", "Premium Student");
            request.setAttribute("email", "lyraa@siswa.edu.my");
            
            RequestDispatcher rd = request.getRequestDispatcher("AccountServlet");
            rd.forward(request, response);
        } else if (user.equals("Fayy") && pass.equals("1234")){
            request.setAttribute("accountType", "Standard Student");
            request.setAttribute("email", "fayy@siswa.edu.my");
